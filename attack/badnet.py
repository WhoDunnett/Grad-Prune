...
class BadNet(NormalCase):
    ...
    def stage1_non_training_data_prepare(self):
        ...
        unique, counts = np.unique(train_poison_index, return_counts=True)
        ...
        ### generate train dataset for backdoor attack with all data
        bd_train_dataset_all = prepro_cls_DatasetBD_v2(
            deepcopy(train_dataset_without_transform),
            poison_indicator=np.ones(len(train_dataset_without_transform)),
            bd_image_pre_transform=train_bd_img_transform,
            bd_label_pre_transform=bd_label_transform,
            save_folder_path=f"{args.save_path}/bd_train_all_dataset"
        )
        ...
        bd_train_dataset_all_with_transform = dataset_wrapper_with_transform(
            bd_train_dataset_all,
            train_img_transform,
            train_label_transform,
        )
        ...
        self.stage1_results = clean_train_dataset_with_transform, \
                              ...
                              bd_train_dataset_all_with_transform, \
    ...
    def stage2_training(self):
        ...
        clean_test_dataloader = DataLoader(clean_test_dataset_with_transform, batch_size=args.batch_size, shuffle=False, drop_last=False, pin_memory=args.pin_memory, num_workers=args.num_workers)
        bd_test_dataloader = DataLoader(bd_test_dataset_with_transform, batch_size=args.batch_size, shuffle=False, drop_last=False, pin_memory=args.pin_memory, num_workers=args.num_workers)
        bd_train_dataloader = DataLoader(bd_train_dataset_with_transform, batch_size=args.batch_size, shuffle=True, drop_last=True, pin_memory=args.pin_memory, num_workers=args.num_workers)
        ...
        save_attack_result(
            ...
            bd_train_all=bd_train_dataset_all_with_transform,
